...
var (
	...
	geckoDriverPath        = flag.String("geckodriver_path", "vendor/geckodriver-v0.19.1-linux64", "The path to the geckodriver binary. If empty of the file is not present, the Geckodriver tests will not be run.")
